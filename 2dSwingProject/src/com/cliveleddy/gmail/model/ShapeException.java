 ...
 * additional expansion. Throwable is also added so that the origin cause from the current exception is
 * caught. <p>
 * The benefit of the Throwable is adding a higher abstraction layer for the exception. However,
 * the original exception must be include in order to preserve the cause. This will keep trace when 
 * debugging the program when the exception is raised.  
 * 
 * @author Clive Leddy
 * @version 1.0
 */
